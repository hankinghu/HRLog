...
class HRLogTranslator extends TreeTranslator {
    ...
    HRLogTranslator(TreeMaker treeMaker, Name.Table names, Messager messager) {
    ...
    public void visitMethodDef(JCTree.JCMethodDecl jcMethodDecl) {
        ...
        note("added HRLog to method " + jcMethodDecl.name+" logStatement "+logStatement.toString());
    }
